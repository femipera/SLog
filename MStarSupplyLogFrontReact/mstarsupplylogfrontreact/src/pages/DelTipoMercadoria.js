...
const DelTipoMercadoria = () => {
    const { id } = useParams();
    const { data: dados, isLoading, error } = HttpGet('https://localhost:7253/api/TipoMercadoria/' + id);
    ...
    const handleSubmit = async (e) => {
        ...
        const sucesso = await HttpDelete('https://localhost:7253/api/TipoMercadoria/' + id);
...
export default DelTipoMercadoria;