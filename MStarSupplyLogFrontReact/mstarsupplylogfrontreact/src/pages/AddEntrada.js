...
const AddEntrada = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const entrada = { mercadoriaId, quantidade, dataHora, local };

        const sucesso = await HttpPost('https://localhost:7253/api/Entrada', entrada);
    ...
    return (
        <div className="create">
            <h2>Adicionar uma nova entrada</h2>
